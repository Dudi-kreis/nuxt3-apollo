  ...
  <div class="bg-gray-100 h-screen justify-center">
    <center class="mt-24 m-auto">
      <svg class="emoji-404 " enable-background="new 0 0 226 249.135" height="249.135" id="Layer_1" overflow="visible"
           version="1.1" viewBox="0 0 226 249.135" width="226" xml:space="preserve"><circle cx="113" cy="113" fill="#FFE585" r="109"/>
    ...
    <center class="mt-6">
      <button @click="handleClearError"
              class="text-gray-500 font-mono text-xl bg-gray-200 p-3 rounded-md hover:shadow-md">Go Home
      </button>
    </center>
  </div>
</template>
